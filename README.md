...
本项目是由 **虾小宝 (SkillAtlas)** 官方团队倾力打造的 Agent 实践开源项目。我们致力于探索大模型在复杂商业推理与 LBS 真实地理数据上的极限落地能力，拒绝纸上谈兵。获得更多体验，欢迎访问：[https://ai.skillatlas.cn/](https://ai.skillatlas.cn/)

如果你对 Agent 的高阶技能开发、工作流架构设计感兴趣，或者想了解关于虾小宝生态的最新黑科技玩法与实战经验，欢迎**扫码添加虾小宝官方**，进入我们的开发者交流社群，一起搞出下一个爆款应用！

<p align="center">
  <img src="docs/xiaxiaobao_qr.png" width="300" alt="虾小宝官方社群二维码">
</p>
